...
public class MapInitializeState : StateBase {
	...
	override public bool OnBeforeInit()
	{
		...
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(610));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(611));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(612));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(612));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(613));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(613));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(614));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(614));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(615));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(616));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(616));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(617));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(617));
		MapDataCarrier.Instance.OriginalDeckList.Add(MasterAction2Table.Instance.GetData(618));
...
/*		for (int i = 0; i < 6; i++) {
		...
		MasterArtifactTable.Data data = MasterArtifactTable.Instance.GetData(11);
		Scene.AddArtifactObject(data);
		MapDataCarrier.Instance.RemoveRarityNoAcquiredArtifactList(11);
