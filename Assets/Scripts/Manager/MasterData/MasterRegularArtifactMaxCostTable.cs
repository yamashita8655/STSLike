...
public class MasterRegularArtifactMaxCostTable : SimpleSingleton<MasterRegularArtifactMaxCostTable>
{
	public class Data {
	...
	{
		if (DataDict.Count > 0) {
			LogManager.Instance.Log("MasterRegularArtifactMaxCostTable:Initialize return.");
			return;
		}
