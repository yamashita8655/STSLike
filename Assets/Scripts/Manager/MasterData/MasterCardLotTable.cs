...
public class MasterCardLotTable : SimpleSingleton<MasterCardLotTable>
{
	public class Data {
	...
	private readonly string FilePath = "csv/cardlottable";
	...
	{
		if (DataDict.Count > 0) {
			LogManager.Instance.Log("MasterCardLotTable:Initialize return.");
			return;
		}
